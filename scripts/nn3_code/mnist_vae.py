...
## Add the custom loss function, with additional arguments.
vae.add_loss(vae_loss(input_image, output_image, z_mean, z_log_var))
...
# Save the models.
vae.save('data/mnist_vae.keras')
encoder.save('data/mnist_encoder.keras')
decoder.save('data/mnist_decoder.keras')
